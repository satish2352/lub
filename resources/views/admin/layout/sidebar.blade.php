...
<li class="nav-item">
    ...
    <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
            <li class="nav-item">
                <a class="nav-link" href="{{ asset('admin/pages/sidebar_pages/ui-features/buttons.html') }}">Buttons</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"
                    href="{{ asset('admin/pages/sidebar_pages/ui-features/dropdowns.html') }}">Dropdowns</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"
                    href="{{ asset('admin/pages/sidebar_pages/ui-features/typography.html') }}">Typography</a>
            </li>
        </ul>
    </div>
</li>
<li class="nav-item">
    <a class="nav-link" href="{{ asset('admin/pages/sidebar_pages/icons/mdi.html') }}">
        <i class="mdi mdi-contacts menu-icon"></i>
        <span class="menu-title">Icons</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="{{ asset('admin/pages/sidebar_pages/forms/basic_elements.html') }}">
        <i class="mdi mdi-format-list-bulleted menu-icon"></i>
        <span class="menu-title">Forms</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="{{ asset('admin/pages/sidebar_pages/charts/chartjs.html') }}">
        <i class="mdi mdi-chart-bar menu-icon"></i>
        <span class="menu-title">Charts</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="{{ asset('admin/pages/sidebar_pages/tables/basic-table.html') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <p class="text-muted mb-0"> Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore. <b>Learn More</b>
                                    </p>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin/assets/images/faces/face10.jpg') }}"
                                                        alt="image" />
                                                    <div class="table-user-name ml-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin/assets/images/faces/face13.jpg') }}"
                                                        alt="image" />
                                                    <div class="table-user-name ml-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin/assets/images/faces/face16.jpg') }}"
                                                        alt="image" />
                                                    <div class="table-user-name ml-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                                <img class="survey-img mb-lg-3"
                                    src="{{ asset('admin/assets/images/dashboard/img_3.jpg') }}" alt="" />
                                <div class="pt-2">
                            ...
                            <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                <img class="survey-img mb-lg-3"
                                    src="{{ asset('admin/assets/images/dashboard/img_1.jpg') }}" alt="" />
                                <div class="pt-2">
                            ...
                            <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                <img class="survey-img mb-lg-3"
                                    src="{{ asset('admin/assets/images/dashboard/img_2.jpg') }}" alt="" />
                                <div class="pt-2">
                                    ...
                                    <div class="row">
                                        <div class="col-4 col-md-4">
                                            <img class="customer-img"
                                                src="{{ asset('admin/assets/images/faces/face22.jpg') }}"
                                                alt="" />
                                        </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="col-4 col-sm-4">
                                            <img class="customer-img"
                                                src="{{ asset('admin/assets/images/faces/face25.jpg') }}"
                                                alt="" />
                                        </div>
                                        ...
                                        <span class="d-inline-block">
                                            <span class="d-flex d-inline-block">
                                                <img class="ml-1"
                                                    ...
                                                    alt="" />
                                                <img class="ml-1"
                                                    src="{{ asset('admin/assets/images/faces/face10.jpg') }}"
                                                    alt="" />
                                                <img class="ml-1"
                                                    src="{{ asset('admin/assets/images/faces/face14.jpg') }}"
                                                    alt="" />
                                            </span>
                                        </span>
                                    </p>
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-between pb-3 border-bottom">
                                        <div>
                                            <img class="mr-2"
                                                src="{{ asset('admin/assets/images/browser-logo/opera-logo.png') }}"
                                                alt="" />
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-between pb-3 border-bottom">
                                        <div>
                                            <img class="mr-2"
                                                src="{{ asset('admin/assets/images/browser-logo/safari-logo.png') }}"
                                                alt="" />
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-between pb-3 border-bottom">
                                        <div>
                                            <img class="mr-2"
                                                src="{{ asset('admin/assets/images/browser-logo/chrome-logo.png') }}"
                                                alt="" />
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-between pb-3 border-bottom">
                                        <div>
                                            <img class="mr-2"
                                                src="{{ asset('admin/assets/images/browser-logo/firefox-logo.png') }}"
                                                alt="" />
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <img class="mr-2"
                                                src="{{ asset('admin/assets/images/browser-logo/explorer-logo.png') }}"
                                                alt="" />
